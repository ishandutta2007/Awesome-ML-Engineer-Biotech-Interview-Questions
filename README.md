...
|---|----------|-----------------|
| 1 | [ML System Design for Biotech](questions/01-ml-system-design-for-biotech.md) | Designing end-to-end ML systems around biological data and workflows |
...
| 5 | [Infrastructure, Compute & Cost](questions/05-infrastructure-compute-and-cost.md) | HPC/cloud tradeoffs, GPU scheduling, storage for genome-scale data |
...
| 8 | [Behavioral & Case Studies](questions/08-behavioral-and-case-studies.md) | Real-world scenarios, system design exercises, ambiguous prioritization calls |
